...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        output_layer_error = (y - activated_output) * np.vectorize(output_layer_activation_derivative)(output)
        hidden_layer_error = np.multiply(self.hidden_to_output_weights.T, np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input))*output_layer_error
